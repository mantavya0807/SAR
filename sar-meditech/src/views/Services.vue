<template>
    <main class="w-full mt-16"> <!-- Adjust top margin for fixed navbar -->
      <!-- Hero Section -->
      <section class="hero bg-gradient-to-tr from-accent via-primary to-secondary text-white h-64 md:h-96 flex items-center justify-center relative" data-aos="fade-down">
      ...
      <section class="cta bg-accent text-white py-16 w-full" data-aos="fade-up">
        <div class="mx-auto px-4 max-w-7xl text-center">
          ...
          <router-link to="/contact-us" class="px-6 py-3 bg-primary-light rounded-lg hover:bg-primary transition-colors duration-300">
            Get in Touch
          </router-link>
        </div>
      </section>
      ...
      const services = ref<Service[]>([
        {
          ...
          image: 'https://placehold.co/600x400/png?text=Medical+Equipment',
          details: 'Our Medical Equipment Supply service ensures that your healthcare facility is equipped with the latest and most reliable medical instruments. We offer a wide range of products, including diagnostic tools, surgical instruments, and patient care equipment, all sourced from reputable manufacturers.',
        },
        {
          title: 'Healthcare Consulting',
          description: 'Expert advice to optimize your healthcare operations.',
          image: 'https://placehold.co/600x400/png?text=Healthcare+Consulting',
          details: 'Our Healthcare Consulting services are designed to help you streamline your operations, improve patient care, and enhance overall efficiency. Our team of experts works closely with you to identify areas of improvement and implement strategic solutions that drive success.',
        },
        {
          title: 'IT Solutions for Healthcare',
          description: 'Innovative IT services to support your healthcare infrastructure.',
          image: 'https://placehold.co/600x400/png?text=IT+Solutions',
          details: 'We provide comprehensive IT Solutions tailored for the healthcare industry. From electronic health records (EHR) implementation to cybersecurity measures, our services ensure that your IT infrastructure is robust, secure, and compliant with industry standards.',
        },
        {
          title: 'Medical Training Programs',
          description: 'Training programs to enhance the skills of your healthcare staff.',
          image: 'https://placehold.co/600x400/png?text=Medical+Training',
          details: 'Our Medical Training Programs are designed to equip your healthcare staff with the necessary skills and knowledge to excel in their roles. We offer a variety of courses, including clinical training, administrative workshops, and specialized certifications, all led by experienced professionals.',
        },
          ]);
          ...
          const testimonials = ref<Testimonial[]>([
        {
          ...
          message: 'SAR Meditech has significantly improved our equipment procurement process with their reliable and efficient services.',
          photo: 'https://placehold.co/200x200/png?text=Alice',
        },
        {
          id: 2,
          name: 'Michael Lee',
          position: 'Chief Medical Officer',
          message: 'Their healthcare consulting services have been invaluable in optimizing our operations and enhancing patient care.',
          photo: 'https://placehold.co/200x200/png?text=Michael',
        },
        {
          id: 3,
          name: 'Sarah Williams',
          position: 'IT Manager',
          message: 'The IT solutions provided by SAR Meditech have strengthened our infrastructure and ensured compliance with industry standards.',
          photo: 'https://placehold.co/200x200/png?text=Sarah',
        },
          ]);
